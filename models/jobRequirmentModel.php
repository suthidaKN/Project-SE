...
class Prof{
    ...
    public function __construct($JobID,$JobTypeID,$JobTypeName,$JobDate,$stuID,$stuFN, $stuLN,$stuPhone,$stuFB,$titleID,$titleName,$pID,$pTitle,$pFN,$pLN,$pEmail,$pPhone,$approvedID,$approvedName,$passID,$passName,$cID,$cName,$cAddress,$cStreet,$districtsID,$zipcode,$districtsName,$amphureID,$amphureName,$provinceID,$provinceName,$JobPosition,$JobBossName,$JobBossPosition,$JobCoordinatorName,$JobCoordinatorTel,$JobCoordinatorEmail,$JobStartDate,$JobEndDate,$JobPay,$JobAccommodation)
    {
        $this->JobID = $JobID;
